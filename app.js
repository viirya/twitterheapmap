...
(function() {
  var TfIdf, app, cli, compile, express, io, messages, natural, nib, redis, redis_client, server, socket_clients, stopwords, stylus, tfidf, tokenizer, util;
  ...
  redis_client.on("message", function(channel, message) {
    ...
    tokens = tokenizer.tokenize(parts_msg[1].toLowerCase());
